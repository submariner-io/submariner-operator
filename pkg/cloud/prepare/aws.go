...
func AWS(port cloud.Port, info *aws.Options, restMapper meta.RESTMapper, dynamicClient dynamic.Interface, reporter api.Reporter) error {
	...
	err := aws.RunOnAWS(info, restMapper, dynamicClient, info.GWInstance,
