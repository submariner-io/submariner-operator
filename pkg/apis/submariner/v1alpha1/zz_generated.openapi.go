...
func schema_pkg_apis_submariner_v1alpha1_ServiceDiscoverySpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"controller": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/submariner-io/submariner-operator/pkg/apis/submariner/v1alpha1.ServiceDiscoveryController"),
						},
					},
					"agent": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/submariner-io/submariner-operator/pkg/apis/submariner/v1alpha1.ServiceDiscoveryAgent"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/submariner-io/submariner-operator/pkg/apis/submariner/v1alpha1.ServiceDiscoveryAgent", "github.com/submariner-io/submariner-operator/pkg/apis/submariner/v1alpha1.ServiceDiscoveryController"},
	}
}
