...
var files = []string{
	"crds/submariner.io_submariners.yaml",
	"crds/submariner.io_servicediscoveries.yaml",
	"role.yaml",
	"role_binding.yaml",
	"service_account.yaml",
	"submariner/globalnet_cluster_role.yaml",
	"submariner/globalnet_cluster_role_binding.yaml",
	"submariner/crds/submariner.io_clusters.yaml",
	"submariner/crds/submariner.io_endpoints.yaml",
