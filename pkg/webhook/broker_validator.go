...
func (v *BrokerValidator) handleAggregatedServiceImport(req *admission.Request, serviceImport *mcsv1b1.ServiceImport, clusterID string,
) admission.Response {
	if req.Operation == admissionv1.Update {
		old := &mcsv1b1.ServiceImport{}
