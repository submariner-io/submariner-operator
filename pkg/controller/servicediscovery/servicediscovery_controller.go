...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileServiceDiscovery{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func (r *ReconcileServiceDiscovery) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	err = r.client.Get(context.TODO(), types.NamespacedName{Name: instance.Spec.SubmarinerName, Namespace: request.Namespace}, submariner)
	if err != nil {
		return reconcile.Result{}, err
	}
...
func newPodForCR(cr *submarinerv1alpha1.ServiceDiscovery) *corev1.Pod {
